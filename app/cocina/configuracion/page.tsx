...
export default function CocinaConfiguracionPage() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const r = await fetch("/api/cocina/cuenta", { cache: "no-store" });
  ...
  const handleGuardar = async () => {
    ...
    try {
      ...
      const r = await fetch("/api/cocina/cuenta", {
        method: "PUT",
                ...
                <div className="space-y-5">
                  <Field label="Contraseña actual">
                    <input
                      ...
                      placeholder={
                        emailCambio || passwordCambio
                          ? "Obligatoria si cambiás email o contraseña"
                          : "Solo si cambiás email o contraseña"
                      }
                    />
                  </Field>
